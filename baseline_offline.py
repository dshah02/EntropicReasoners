...
parser = argparse.ArgumentParser(description='Cache model and tokenizer for offline use')
parser.add_argument('--model', type=str, default = "llama", required=False, help='Name of the model to cache')
