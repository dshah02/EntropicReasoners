#!/bin/sh
#SBATCH --job-name=baseline_llama # create a short name for your job
#SBATCH --output=slurm/slurm_output/april10/baseline/%x_%j.out
#SBATCH --error=slurm/slurm_output/april10//baseline/%x_%j.err
